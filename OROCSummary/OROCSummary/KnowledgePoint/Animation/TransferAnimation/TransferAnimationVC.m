...
@interface TransferAnimationVC () <UITableViewDataSource, UITableViewDelegate>
...
@implementation TransferAnimationVC
...
- (UITableView *)tableView{
    ...
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavBarHeight ,Screen_Width , Screen_Height - kNavBarHeight) style:UITableViewStyleGrouped];
