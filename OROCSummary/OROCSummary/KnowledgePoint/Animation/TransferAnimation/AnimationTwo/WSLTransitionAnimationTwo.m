...
- (void)pushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    }else if([[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey] isKindOfClass:[TransferAnimationVC class]]){
        fromVC = (TransferAnimationVC *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    }
    //取出转场前后视图控制器上的视图view
...
- (void)popAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    }else if([[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey] isKindOfClass:[TransferAnimationVC class]]){
        toVC = (TransferAnimationVC *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    }
